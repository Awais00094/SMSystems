...
namespace SMSystems
{
    public partial class MainForm : Form
    {
        ...
        void m_oWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            else if (formName.Equals("shoppingForm"))
            {
                containerForm = new ShoppingForm();
                doProgress();
            }
        ...
        private void ShoppingBtn_Click(object sender, EventArgs e)
        {
            ...
            if (!m_oWorker.IsBusy)
            {
                m_oWorker.RunWorkerAsync("shoppingForm");
            }
        ...
        private void MinimizeMaximizeBtn_Click(object sender, EventArgs e)
        {
