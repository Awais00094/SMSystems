...
namespace SMSystems
{
    public partial class CategoryForForm : Form
    {
        public long ID = -1;
        public CategoryForForm()
        {
            InitializeComponent();
            FillGrid();
        ...
        private void Addbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                model.TableNo = 3;  //Category For
                if (model.Name != null || model.Name != "")
                {
                    string ID =CommonBLL.CommonDataInsert(model);
                    MessageBox.Show("Shoe Category For Added Successfully !..."+ID);
        ...
        {
            var dt = CommonBLL.GetCategoryForList();
        ...
        private void updatebtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                model.TableNo = 3;  //Colors
                if (model.Name != null || model.Name != "")
                {
                    CommonBLL.CommonDataUpdate(model);
                    MessageBox.Show("Shoe Category For Updated Successfully !..." + ID);
        ...
        private void CategoryForForm_Load(object sender, EventArgs e)
        {
