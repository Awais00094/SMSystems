...
namespace SMSystems
{
    public partial class ShoesTypeForm : Form
    {
        public long ID = -1;
        public ShoesTypeForm()
        {
            InitializeComponent();
            FillGrid();
        ...
        private void Addbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                model.TableNo = 2;  //Product Categories
                if (model.Name != null || model.Name != "")
                {
                    string ID =CommonBLL.CommonDataInsert(model);
                    MessageBox.Show("Shoe Type Added Successfully !..."+ID);
        ...
        {
            var dt = CommonBLL.GetShoeTypeList();
        ...
        private void updatebtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (model.Name != null || model.Name != "")
                {
                    ...
                    MessageBox.Show("Shoe Type Updated Successfully !..." + ID);
