    ...
    public partial class PurchaseForm : Form
    {
        ...
        private void AddPurchasebtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Purchase Successfully Done!...");
                }
                else if (Er != SMSError.SUCCESS)
                {
                    MessageBox.Show("Purchase Not Successfull" + Er);
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show("Purchase Not Successfull!.." + ex.Message);
            }
        }
        ...
        {
            PurchaseProductDetailItem item;
            ...
            else
            {
                if (product.ID != 0)
                {
                    ...
                    if (item != null)
                    {
                        MessageBox.Show("ArticalNo Already Exists Please Delete It First!... ");
                    }
                    else
                    {
                        item = new PurchaseProductDetailItem();
